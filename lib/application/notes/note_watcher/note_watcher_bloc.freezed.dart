...
mixin _$NoteWatcherState {
  ...
  TResult map<TResult extends Object>({
    ...
    @required TResult loadProgress(_LoadProgress value),
  ...
  TResult maybeMap<TResult extends Object>({
    ...
    TResult loadProgress(_LoadProgress value),
...
/// @nodoc
abstract class _$LoadProgressCopyWith<$Res> {
  factory _$LoadProgressCopyWith(
          _LoadProgress value, $Res Function(_LoadProgress) then) =
      __$LoadProgressCopyWithImpl<$Res>;
}
...
class __$LoadProgressCopyWithImpl<$Res>
  ...
  __$LoadProgressCopyWithImpl(
      _LoadProgress _value, $Res Function(_LoadProgress) _then)
      : super(_value, (v) => _then(v as _LoadProgress));

  @override
  _LoadProgress get _value => super._value as _LoadProgress;
}

/// @nodoc
class _$_LoadProgress implements _LoadProgress {
  const _$_LoadProgress();

  @override
  String toString() {
    return 'NoteWatcherState.loadProgress()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _LoadProgress);
  }
...
abstract class _LoadProgress implements NoteWatcherState {
  const factory _LoadProgress() = _$_LoadProgress;
}
